...
export default {
  ...
  plugins: [
    // Insert host and port from environment variables
    replace({
      values: {
        "process.env.SERVER_HOST": JSON.stringify(process.env.SERVER_HOST),
        "process.env.SERVER_PORT": JSON.stringify(process.env.SERVER_PORT),
        "process.env.IS_PRODUCTION": JSON.stringify(production),
      },
    ...
    sass({ output: "./build/global.css" }),

    json(),

    static_files({ include: ["./static"] }),
